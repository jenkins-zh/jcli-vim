...
function! ExecPipelineJob()
  let file_name = expand('%:t:r')
  "substitute(file_name, "-", "/", "g")
  let file_name = file_name[12:]
  let file_name = Base64decode(file_name)
  let full_path = expand('%')
  call Save()
  execute "!jcli job edit " . file_name . " --filename " . full_path . " && jcli job build " . file_name . " -b"
endfunction
...
function! Base64encode(input)
	...
	elseif has("unix")
		return Base64strip(system('base64 --wrap=0', a:input))
	elseif has("win32")
